...
<template>
  <div>
    ...
    <div :style="cid ? 'max-width: 100% !important;' : ''" class="container">
      <div class="own-input">
        <el-input
            id="own-textarea"
        ...
        <div class="input-bottom">
          <span title="emoji">
            ...
            >
              ...
              <i slot="reference" class="fa fa-smile-o emotionSelect"></i>
            </el-popover>
          </span>
          <span
          ...
          <span class="own-btn-comment">
            <el-button class="btn" round type="primary" @click="commitComment"
      ...
      >
        ...
        <div class="info-bottom">
          ...
          <div class="reply">
            ...
            <div v-if="item.totalReplyNum > 3" class="view-more item">
            ...
            >{{ $t('m.Replies') }},
              ...
              >
              <a v-else class="btn-more" @click="pickWayReply(item)">{{
                  $t('m.Pick_up')
                }}</a>
            </div>
    ...
    <div v-if="showloading" class="container loading-text">
